...
<template>
  <div class="lvl2">
    ...
    <div class="tips" id="tips">
      ...
      <p v-if="!cmd">{{t('Code CSS:')}} {background-color:{{couleur}} {border: {{borderWidth*10}}px {{borderStyle}} {{borderColor}}}</p>
...
this.intro.setOptions({
  steps: [
    {
      ...
      intro: this.t("Astuce : Prends bien le temps lire la version écrite de ton code CSS dans la console en bas de page...<br><br> Cela pourrait te servir plus tard ;)")
    }
  ]
  });
  this.intro.start();
  ...
  locales: {
      ...
      fr_FR: {
        ...
        "Animations":"Animations",
        "Colors":"Couleurs",
        "Tip : You should take take the time to read the written version of your CSS code in the console at the bottom of the page...<br><br> It could come in handy later ;)":"Astuce : Prends bien le temps lire la version écrite de ton code CSS dans la console en bas de page...<br><br> Cela pourrait te servir plus tard ;)"
      }
  }
